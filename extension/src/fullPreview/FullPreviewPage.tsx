...
export function FullPreviewPage() {
  ...
  return (
    <main className="min-h-screen bg-pilot-bg text-pilot-text">
      <header className="border-b border-slate-800 bg-pilot-bg/95 px-8 py-5 backdrop-blur">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="text-xl font-black tracking-tight">PolishPilot Preview</h1>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              className="rounded-lg border border-cyan-300/40 bg-cyan-300 px-4 py-2 text-sm font-black text-slate-950 transition hover:bg-cyan-100 disabled:cursor-not-allowed disabled:border-slate-700 disabled:bg-slate-800 disabled:text-slate-500"
            ...
            <button
              className="rounded-lg border border-slate-700 bg-slate-950/60 px-4 py-2 text-sm font-bold text-slate-100 transition hover:bg-slate-800"
        ...
        {copyStatus ? (
          <p className="mx-auto mt-2 max-w-7xl text-xs font-semibold text-cyan-100">
            {copyStatus}
          </p>
        ) : null}
      </header>
      ...
      <section className="px-8 py-8">
        <div className="mx-auto max-w-[1440px] rounded-2xl border border-slate-800 bg-slate-900/74 p-6 shadow-pilot">
          {data && builtPreview ? (
            <div className="grid gap-5 xl:grid-cols-2">
              <section className="min-w-0">
                <div className="mb-3 flex items-center justify-between gap-3">
                  <h2 className="text-sm font-black text-slate-50">Original screenshot</h2>
                  <span className="rounded-full border border-slate-700 px-2 py-1 text-[11px] font-bold text-slate-300">
                ...
                <div
                  className="flex w-full items-center justify-center overflow-hidden rounded-xl border border-slate-800 bg-slate-950/70"
              ...
              <section className="min-w-0">
                <div className="mb-3 flex flex-wrap items-center justify-between gap-3">
                  <div>
                    <h2 className="text-sm font-black text-slate-50">Humanized live preview</h2>
                ...
                <div
                  className="w-full overflow-hidden rounded-xl border border-slate-800 bg-white"
                  style={previewFrameStyle}
                >
                  <PreviewIframe
            ...
            <div className="flex min-h-[600px] items-center justify-center rounded-xl border border-slate-800 bg-slate-950/50 p-8 text-center">
              <div>
                <h2 className="text-lg font-black text-slate-50">No preview data found</h2>
...
function PreviewDebugPanel({
  ...
  return (
    <div className="mt-3 rounded-xl border border-slate-800 bg-slate-950/70 p-3 text-[11px] leading-5 text-slate-300">
      <div className="mb-2 font-black uppercase tracking-wide text-cyan-100">
        Preview debug
      </div>
